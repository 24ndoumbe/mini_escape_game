<template>
  <div class="room-container">
    ...
    <router-link v-if="toutesLesEnigmesResolues" to="/room2">
      <button class="next-room-button">Passer à la Room Enquête 🚪</button>
    </router-link>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      enigmes: [
        {
          question: "Quelle année a eu la première mission Apollo ?",
          reponse: "1969",
        },
